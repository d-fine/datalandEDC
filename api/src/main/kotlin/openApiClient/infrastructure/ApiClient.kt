package org.eurodat.brokerextension.openApiClient.infrastructure
...
open class ApiClient(val baseUrl: String) {
    companion object {
        ...
        const val baseUrlKey = "org.eurodat.brokerextension.openApiClient.baseUrl"

        @JvmStatic
        val client: OkHttpClient by lazy {
            val logging = HttpLoggingInterceptor()
            logging.setLevel(HttpLoggingInterceptor.Level.BODY)
            builder.addInterceptor(logging).connectTimeout(10, TimeUnit.SECONDS)
    ...
    protected inline fun <reified T: Any?> responseBody(body: ResponseBody?, mediaType: String? = JsonMediaType): T? {
        ...
        if (T::class.java == File::class.java) {
            // return tempfile
            val f = java.nio.file.Files.createTempFile("tmp.org.eurodat.brokerextension.openApiClient", null).toFile()
            f.deleteOnExit()
