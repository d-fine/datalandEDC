...
dependencies {
    ...
    implementation("org.eclipse.dataspaceconnector:control-api:$connectorVersion")
    ...
    implementation("org.eclipse.dataspaceconnector:data-plane-api:$connectorVersion")
    implementation("org.eclipse.dataspaceconnector:data-plane-spi:$connectorVersion")
    implementation("org.eclipse.dataspaceconnector:data-plane-framework:$connectorVersion")
    implementation("org.eclipse.dataspaceconnector:data-plane-http:$connectorVersion")
    implementation("org.eclipse.dataspaceconnector:data-management-api:$connectorVersion")
    implementation("org.eclipse.dataspaceconnector:transfer-functions-core:$connectorVersion")
    implementation("org.eclipse.dataspaceconnector:filesystem-vault:$connectorVersion")
    implementation("org.eclipse.dataspaceconnector:common-util:$connectorVersion")
